...
export const SortProduct = () => {
  ...
  // Define Vitality Works categories in the order you want them displayed
  ...
  const fetchCategories = useCallback(async () => {
    ...
    try {
      ...
      // Show first 6 on homepage, rest on "View All"
      setCategories(sortedCategories.slice(0, 6));
    ...
    <div ref={scope} className="SortProduct__mainWrapper">
      <div className="SP__mainContentWrapper">
        <div className="SP__headerWrapper">
          ...
          {!loading && !error && categories.length > 0 && !showAll && allCategories.length > 6 && (
            <motion.button
